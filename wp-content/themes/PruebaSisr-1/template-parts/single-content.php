<?php if (function_exists('wc_get_product') && (is_cart() || is_shop() || is_product())) { the_content(); } else { ?><?php global $wp_query;
 ?>
<?php $skip_min_height = false; ?><section class="u-align-center u-clearfix u-section-1" id="sec-e7b3">
    ...
    <div class="u-container-style u-expanded-width u-post-details u-post-details-1">
      <div class="u-container-layout u-valign-middle u-container-layout-1"><!--blog_post_image-->
        <?php
                            ...
                            if ($post_image) echo $post_image; else { echo '<div class="hidden-image"></div>'; $skip_min_height = true; } ?><!--/blog_post_image--><!--blog_post_header-->
        ...
        <div class="u-blog-control u-metadata u-metadata-1"><!--blog_post_metadata_date-->
          <span class="u-meta-date u-meta-icon"><?php if($post->post_type !== "page"){ echo get_the_date(); }?></span><!--/blog_post_metadata_date--><!--blog_post_metadata_category-->
          ...
          <?php if (comments_open()): ?><span class="u-meta-comments u-meta-icon"><a class="u-textlink" href="<?php echo get_comments_link(); ?>">
                                        <?php _e(sprintf(__('Comments (%d)', 'pruebasisr'), (int)get_comments_number())); ?>
                                   </a></span><?php endif; ?><!--/blog_post_metadata_comments-->
        </div><!--/blog_post_metadata--><!--blog_post_content-->
        <div class="u-align-justify u-blog-control u-post-content u-text u-text-2"><?php echo is_singular() ? theme_get_content() : theme_get_excerpt(); ?></div><!--/blog_post_content-->
      </div>
