<?php $skip_min_height = false; ?><section class="u-align-center u-clearfix u-section-1" id="sec-78ac">
...
global $wp_query; ?><div class="u-expanded-width u-products u-repeater u-repeater-1"><!--product_item-->
      <?php while ( $wp_query->have_posts() ) : $wp_query->the_post(); $product = wc_get_product($post->ID); ?><div class="u-align-center u-container-style u-products-item u-repeater-item u-white u-repeater-item-1">
