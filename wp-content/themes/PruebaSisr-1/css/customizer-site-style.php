<style id="color-scheme" color-scheme="u14" color-style="multicolor-1">.u-body {
--none: transparent;
...
--custom-color-1: #0d1319;
--custom-color-1-darker: #0c1117;
--custom-color-1-r: 13;
--custom-color-1-g: 19;
--custom-color-1-b: 25;
...
--custom-color-2: #ff5100;
--custom-color-2-darker: #e64900;
--custom-color-2-r: 255;
--custom-color-2-g: 81;
--custom-color-2-b: 0;
--custom-color-2-contrast: white;
--custom-color-2-contrast-darker: white;
--custom-color-2-text-color: var(--body-alt-color);
--custom-color-3: #ff661f;
--custom-color-3-darker: #ff5202;
--custom-color-3-r: 255;
--custom-color-3-g: 102;
--custom-color-3-b: 31;
...
--custom-color-4-darker: #dadada;
--custom-color-4-r: 242;
--custom-color-4-g: 242;
--custom-color-4-b: 242;
--custom-color-4-contrast: black;
--custom-color-4-contrast-darker: black;
--custom-color-4-text-color: var(--body-color);
--custom-color-5: #999999;
--custom-color-5-darker: #8a8a8a;
--custom-color-5-r: 153;
--custom-color-5-g: 153;
...
--custom-color-6: #233343;
--custom-color-6-darker: #202e3c;
--custom-color-6-r: 35;
--custom-color-6-g: 51;
--custom-color-6-b: 67;
...
--bg-contrast: var(--body-color);
        ...
        {
            color: var(--custom-color-6) !important;
        }</style><style id="typography" typography="Normal">
        .u-body
        {
        ...
        /** alt-color-rules **/
    </style><style id="font-scheme" font-scheme="Roboto-OpenSans" heading-font="Roboto,sans-serif" text-font="'Open Sans',sans-serif">.u-body {
